...
def playaudio(text):
    ...
    return
'''
app = Flask(__name__,template_folder="Flask") # initializing a flask app
# Loading the model
model=load_model(r'C:\Users\sujana\OneDrive\Desktop\project1\Flask\cyclone2\disaster.h5')
